class Customer:
    ...
    def __init__(self, cid, lname, fname, pnumber, addy):  # Constructor sets all to no value
        ...
        customer_id_characters = set("1234567890c")
...
# Valid customer
  #  customer_one = Customer('123', 'Duck', 'Donald', '(555)555-5555P', '123 main street') # all required
   # print(str(customer_one))

#Invalid phone
# Wait! try/except needed!
    #try:
    customer_two = Customer('123c', 'Duck', 'Donald', '(555)555-5555', '123 main street') # all required
